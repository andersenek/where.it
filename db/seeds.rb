...
# setting hard-coded user_ids (or any ids really) in your seed script can
# cause issues, because you can't assume a user with that ID exists.
# better to create users first, store them in variables, and then use those
# variables in your Post creation statements to refernece the associated users
posts = Post.create ([
